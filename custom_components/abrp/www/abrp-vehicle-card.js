...
`;function Oe(i){let e=i._vs("sensor.data_source")?.attributes?.providers||{},t=(a,d="ABRP Estimate")=>U(e[a])||d,s=(a,d)=>i._vs(a)?.attributes?.unit_of_measurement??d,o=Number(i._vs("sensor.speed_factor")?.state),r=[["SoC",f(i._vs("sensor.soc")),"%",t("soc"),"sensor.soc"],["Range",f(i._vs("sensor.range")),s("sensor.range","km"),t("est_battery_range"),"sensor.range"],["Calibrated reference consumption",f(i._vs("sensor.reference_consumption")),s("sensor.reference_consumption","Wh/km"),t("calib_ref_cons"),"sensor.reference_consumption"],["Battery capacity",f(i._vs("sensor.battery_capacity")),"kWh",t("battery_capacity",t("capacity")),"sensor.battery_capacity"],["Odometer",f(i._vs("sensor.odometer")),s("sensor.odometer","km"),t("odometer"),"sensor.odometer"],["Location",i._vs("device_tracker.location")?.state,"",t("lat",""),"device_tracker.location"],["Reference speed",Number.isFinite(o)?Math.round(o*100):null,"%",t("speed_factor"),"sensor.speed_factor"],["Maximum speed",f(i._vs("sensor.max_speed")),s("sensor.max_speed","km/h"),t("max_speed"),"sensor.max_speed"],["Elevation",f(i._vs("sensor.elevation")),s("sensor.elevation","m"),t("elevation",""),"sensor.elevation"]],h=[[U(i._vs("sensor.data_source")?.state),i._vs("sensor.source_last_refresh")?.state,"sensor.source_last_refresh"],["Obdble",i._vs("sensor.obd_last_refresh")?.state,"sensor.obd_last_refresh"]].filter(([a,d])=>a&&d&&d!=="unknown"&&d!=="unavailable");return c`<div class="grid">
  ...
  >
    ...
    >
    ...
    </ha-dialog>`}};var tt=[{name:"title",selector:{text:{}}},{name:"device",selector:{device:{integration:k,entity:[{integration:k,domain:"device_tracker"}]}}}],W=[["show_image","Car image",!0],["show_profile","Drive profile selector",!0],["show_charge_speed","Charging speed badge",!0],["show_last_seen","Last seen line",!0],["show_live_data","Live data link",!0],["show_options","Options button",!0],["show_live_data_button","Live data button (alternative to the link)",!1]],st=W.map(([i])=>({name:i,selector:{boolean:{}}})),it={title:"Title (empty = ABRP vehicle name)",device:"Vehicle (empty = first ABRP vehicle)",...Object.fromEntries(W)},V=class extends _{static get properties(){return{hass:{},_config:{},_tab:{state:!0}}}constructor(){super(),this._tab="general"}setConfig(e){this._config=e||{}}render(){if(!this.hass)return c``;let e=this._tab==="general";return c`<div class="tabs">
        <button
          class="tab ${e?"on":""}"
      ...
      ></ha-form>`}_displayData(){return Object.fromEntries(W.map(([e,,t])=>[e,this._config[e]??t]))}_valueChanged(e){e.stopPropagation();let t={...this._config,...e.detail.value,type:`custom:${$}`};t.device||delete t.device,t.title||delete t.title;for(let[s,,o]of W)(t[s]===o||t[s]===void 0)&&delete t[s];this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}static get styles(){return P`
      .tabs {
        display: flex;
        border-bottom: 1px solid var(--divider-color);
        margin-bottom: 16px;
