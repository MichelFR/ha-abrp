    ...
    >
      <div class="confirm-body">
        <div class="confirm-text">
          This changes the active drive profile from "${e.state}" to
          "${t}" in ABRP.
        </div>
